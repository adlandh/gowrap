...
import (
	...
	"github.com/adlandh/gowrap/generator"
	"github.com/adlandh/gowrap/pkg"
)
...
func NewGenerateCommand(l remoteTemplateLoader) *GenerateCommand {
	...
	fs.StringVar(&gc.sourcePkg, "p", "", "the source package import path, i.e. \"io\", \"github.com/adlandh/gowrap\" or\na relative import path like \"./generator\"")
