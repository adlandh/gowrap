...
//go:generate gowrap gen -p github.com/adlandh/gowrap/templates_tests -i TestInterface -t ../templates/opencensus -o interface_with_opencensus.go -v DecoratorName=TestInterfaceWithOpenCensus -l ""
