...
//go:generate gowrap gen -p github.com/adlandh/gowrap/templates_tests -i InterfaceWithTwirpError -t ../templates/twirp_error -o interface_with_twirp_error.go -l ""
